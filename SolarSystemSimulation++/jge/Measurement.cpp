...
#define BACK_BUFFER 1
    ...
    {
        GLuint64 start, stop;
        glGetQueryObjectui64v(queryIds[front][0], GL_QUERY_RESULT, &start);
        glGetQueryObjectui64v(queryIds[front][1], GL_QUERY_RESULT, &stop);
        return static_cast<unsigned int>(stop - start);
    }
}